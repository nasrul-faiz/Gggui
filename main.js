    ...
    try {
        ...
        switch (true) {
            ...
            case userMessage.startsWith('.fb') || userMessage.startsWith('.facebook'):
                ...
                break;
            case userMessage.startsWith('.music') || userMessage.startsWith('.lagu') || userMessage.startsWith('.song'):
                await ytmp3Command(sock, chatId, message);
                break;
            case userMessage.startsWith('.spotify'):
                await spotifyCommand(sock, chatId, message);
                break;
            case userMessage.startsWith('.ytmp3') || userMessage.startsWith('.mp3') || userMessage.startsWith('.audio'):
                await ytmp3Command(sock, chatId, message);
                break;
